...
%Version 1 (as described in the paper).
...
[IDs, ~]= DBSCAN(rgb2lab(C_initial),17,2); %change the threshold to get different results. Here, we use 17 as a threshold of deltaE76 value.
K = max(unique(IDs));
sigma=40; %sigma
